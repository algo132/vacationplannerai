...
destinations = pd.DataFrame({
    ...
    'latitude': [48.8566, 40.7128, 35.6895, -33.8688, -33.9249],
    'longitude': [2.3522, -74.0060, 139.6917, 151.2093, 18.4241]
})

# Train a Nearest Neighbors model
model = NearestNeighbors(n_neighbors=3)
model.fit(destinations[['latitude', 'longitude']])

# Stripe API configuration
stripe.api_key = 'sk_live_51N3fmxGVHgwoZ03xacEbfn7pCJmpqVKRyrToryvYkQ93TgZkrl5EIODN'
...
def recommend():
    ...
    distances, indices = model.kneighbors([[user_lat, user_lon]])
    recommendations = destinations.iloc[indices[0]].to_dict(orient='records')
